...
You can assign keybord shortcuts to any of these addins if you wish.
...
The simplest way to get started on developing a `SpaDES` module, is to start from an exsiting module.
